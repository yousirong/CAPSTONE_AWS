...
export default function DetailComponent({
  ...
  return (
    <Card {...other}>
      <CardHeader store_name={store_name} sub_category={cat_3} />
...
DetailTaskItem.propTypes = {
  formik: PropTypes.object,
  checked: PropTypes.bool,
  task: PropTypes.object,
};

function DetailTaskItem({ formik, task, checked, ...other }) {
...
function DetailMenuButton({ actions, open, onOpen, onClose }) {
  return (
    <>
